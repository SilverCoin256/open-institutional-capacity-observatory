...
SOURCE_SPECS = [
    {
        ...
        "source_url": "https://www.justice.gov/eoir/workload-and-adjudication-statistics",
        ...
        "provenance_note": "The stored 11-row table is a frozen historical artifact associated with an earlier EOIR publication state. The official workload page and linked PDF are mutable and may revise historical values; the current official publication is documented separately in datasets/metadata/eoir_snapshot_provenance.md.",
        ...
        "notes": "Frozen artifact window: FY2016-FY2026 Q2. Study 1 authoritative inference: FY2016-FY2024, 9 observations and 8 transitions. Current official values are not substituted into the frozen artifact.",
    },
    {
        ...
        rows.append(
            {
                ...
                "retrieved_at": "historical_snapshot_date_not_recoverable; official publication audited 2026-09-05",
                "license_audit_date": "2026-09-05",
